        ...
        {Array.from({ length: config.totalDays }, (_, i) => {
          ...
          return (
            <div
              key={i}
              className={[
                'absolute top-0 h-full border-r border-[var(--border)] dark:border-[var(--border)]',
                isWeekend ? 'bg-[var(--bg-subtle)] dark:bg-[var(--bg-subtle)]' : '',
              ].join(' ')}
      ...
      >
        {cols.map((col, idx) => (
          <div
            ...
            className={[
              'absolute top-0 h-full border-r border-[var(--border)] dark:border-[var(--border)]',
              col.shaded ? 'bg-[var(--bg-subtle)] dark:bg-[var(--bg-subtle)]' : '',
            ].join(' ')}
